	...
	return (
		<div ref={setNodeRef} style={style} className="flex h-12 items-center">
			<Link
				aria-label="Goal tag"
				href={href}
				className={`flex h-full  w-full cursor-pointer  items-center justify-between bg-topbar pr-4 text-xl  transition-all duration-300 ease-in-out hover:bg-[#446288] ${selectedGoal === id.toString() ? "bg-[#446288]" : "bg-topbar"
					}`}
			>
